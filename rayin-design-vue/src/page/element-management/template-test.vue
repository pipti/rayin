        ...
        <el-tabs :tab-position="tabPosition" type="border-card"
          ...
          <el-tab-pane label="数据">
            <el-row>
              ...
              <el-col :span="19">
                <el-button icon="el-icon-document-checked" circle title="测试" @click="testClick" size="small">
                </el-button>
                ...
                <el-button icon="el-icon-download" size="small" circle @click="dataDownloadClick" title="下载数据">
                </el-button>
              </el-col>
            </el-row>
            <el-row :span="24">
...
export default {
  ...
  methods: {
    ...
    testClick() {
      ...
      axios.post(
        this.GLOBAL.webappApiConfig.TemplateManagement.UserTemplateView.url,
        this.tplRow,
        {},
      )
        .then((res) => {
