      ...
      <el-row>
        ...
        <el-col :span="8">
          <div style="width: 100%;text-align: left">
            <el-link :underline="false"  style="margin-top: 15px;font-size:22px;margin-right:30px" type="primary"
                     @click="titleRouterClick('orgs')">{{$i18n.t('project')}}</el-link>
            <!--<el-link :underline="false" style="margin-top: 15px;font-size:22px;margin-right:30px"
            type="primary" v-if="this.$store.state.organizationName !== null"
        ...
        <el-col :span="7">
          <div style="width:100%;text-align:right;margin-top:10px;" >
            ...
            <!--<span class="el-dropdown-link">-->
              <div style="border-left:5px solid #409EFF;padding-left: 10px;height:30px;
              padding-bottom:3px;text-align: left;"
                ...
                <!--{{this.$store.state.organizationName}}-->
                  <div v-if="this.$store.state.organizationName !== null">
                    {{ this.$store.state.organizationName.substring(0,10) }}
        ...
        <el-col :span="4">
          <div style="width:100%;text-align: right;">
            ...
            <el-link style="margin-bottom: 10px">{{$i18n.t('help')}}</el-link>
            <el-dropdown trigger="click" @command="handleCommand">
            <span class="el-dropdown-link">
