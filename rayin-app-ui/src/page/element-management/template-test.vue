...
<template>
  <div>
    ...
    <el-row :gutter="5" :style="{marginTop:'20px',height: this.$store.state.boxHeight}">
      ...
      <el-col :span="7">
        <el-tabs :tab-position="tabPosition" type="border-card" :style="{height:(this.$store.state.windowHeight - 150)+ 'px'}" id="resourceTab">
          <el-tab-pane label="模板">
            ...
            <span>{{this.tplRow.startTimeStr}}</span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;~<br>
          ...
          <el-tab-pane label="数据">
            <el-row>
              <el-col :span="5">
                ...
                >
                  <el-button icon="el-icon-folder-opened" circle title="加载数据" size="small"></el-button>
                  <!--<el-button size="small" type="primary">点击加载本地数据</el-button>-->
                </el-upload>
              </el-col>
              <el-col :span="19">
                <el-button icon="el-icon-document-checked" circle title="测试" @click="testClick" size="small"></el-button>
                ...
                <el-button icon="el-icon-download" size="small" circle @click="dataDownloadClick" title="下载数据"></el-button>
              </el-col>
            </el-row>
            <el-row :span="24">
...
export default {
  ...
  methods: {
    ...
    dataSaveClick () {
      this.tplRow.testData = JSON.stringify(this.jsonData)
      axios.post(this.GLOBAL.webappApiConfig.TemplateManagement.UserTemplateTestDataSave.url,
        this.tplRow,
        {})
        .then(res => {
    ...
    dataDownloadClick () {
      if (this.jsonData != null) {
        ...
        FileSaver.saveAs(blob, this.tplRow.name + '_data.json')
      }

      // this.tplRow.testData = JSON.stringify(this.jsonData)
      //      axios.post(this.GLOBAL.webappApiConfig.TemplateManagement.UserTemplateTestDataDownlaod.url,
      //        this.tplRow,
      //        {})
      //        .then(res => {
      //
