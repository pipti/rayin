  ...
  <el-container>
    ...
    <el-main>
      <el-row>
        ...
        <el-col :span="9">
          <el-card style="width:450px;margin-top:110px;height:480px;border-radius: 0px;text-align: left">
            <el-form ref="form" :model="form"  :rules="rules" label-width="0px"  >
              ...
              <el-form-item label="" class="sign-input" prop="username">
                <el-input v-model="form.username" placeholder="手机号码" style="width:80%;" tabindex="1"></el-input>
              </el-form-item>
              <el-form-item label="" class="sign-input" prop="imgCode">
                <el-input v-model="form.imgCode" placeholder="请输入图片验证码" style="width:47%" @keyup.enter.native="signup" tabindex="3"></el-input>
                <el-image :src="codeUrl" style="width:32%" @click="refurbishCode"/>
              </el-form-item>
              <el-form-item label="" prop="verifyCode">
                <el-input v-model="form.verifyCode" placeholder="输入短信验证码" style="width:40%"></el-input>
              ...
              <el-form-item label="" class="sign-input" prop="password">
                <el-input v-model="form.password" type="password" placeholder="用户密码" style="width:80%" tabindex="2"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" icon="el-icon-user-solid" @click="signup" style="width:80%" :loading="logining">立即注册</el-button>
                <hr>
...
/* eslint-disable */
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          verifyCode: [
            {required: true, message: '短信验证码为必填项', trigger: 'blur'}
          ],
          imgCode: [
            {required: true, message: '图片验证码为必填项', trigger: 'blur'}
          ]
        },
    ...
    methods: {
      ...
      getPhoneCode(){
        let param = {'username': this.form.username,'imgCode': this.form.imgCode}
        axios.post('/api/users/sendSms', param).then( res => {
        })
      ...
      refurbishCode() {
        ...
        this.codeUrl = '/api/users/code/image?' + num
      }
    },mounted(){
      this.refurbishCode()
    }
