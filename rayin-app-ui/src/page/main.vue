  ...
  <el-container>
    <el-header style="padding:0 0;height:45px;border-bottom:solid 1px #e6e6e6;">
      <el-row>
        ...
        <el-col :span="8">
            <div style="width: 100%;text-align: left">
              <el-link :underline="false"  style="margin-top: 15px;font-size:22px;margin-right:30px" type="primary" @click="titleRouterClick('orgs')">
                项目</el-link>
              <!--<el-link :underline="false"  style="margin-top: 15px;font-size:22px;margin-right:30px" type="primary" @click="titleRouterClick('guide')">设计</el-link>-->
              <!--<el-link :underline="false"  style="margin-top: 15px;font-size:22px;margin-right:30px" type="primary" @click="titleRouterClick('members')">成员</el-link>-->
            </div>
        </el-col>
        <el-col :span="7">
          <div style="width:100%;text-align:right;margin-top:10px;" >
            ...
            <span class="el-dropdown-link">
             <div style="border-left:5px solid #409EFF;padding-left: 10px;height:30px;padding-bottom:3px">
               <el-link style="font-size:25px;" type="primary" :underline="false"> {{this.$store.state.organizationName}}</el-link>
             </div>
            </span>
      ...
      <el-aside width="auto" style="border-right:solid 1px #e6e6e6;" >
        ...
        style="border-right:solid 0px #e6e6e6;" >
          <el-submenu index="2">
            ...
            <el-menu-item v-for="menu in menus" :key="menu.index" :index="menu.index" :route="menu.route" v-if="menu.show" :disabled="menu.disable" >
              <i :class="menu.icon"></i>
              <span>{{menu.name}}</span>
            </el-menu-item>
...
export default {
  ...
  created () {
    ...
    this.menus.push({name: '向导', index: '2-1', route: '/main/guide', icon: 'el-icon-help', show: true, disable: false})
    this.menus.push({name: '构件设计', index: '2-2', route: '/main/element-management', icon: 'el-icon-document', show: true, disable: false})
    this.menus.push({name: '模板配置', index: '2-3', route: '/main/template-management', icon: 'el-icon-document-copy', show: true, disable: false})
