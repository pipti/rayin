...
//            }
            ...
            PDDocument doc = PDDocument.load(pdfBos.toByteArray());
            int pagesa = pdd.getNumberOfPages();
            if(StringUtil.isNotBlank(pages)){
               ...
               // PDDocument extractDoc = new PDDocument();
                for(String k : pageB){
                    ...
                    pdd.addPage(doc.getPage(Integer.valueOf(k)));
                }
